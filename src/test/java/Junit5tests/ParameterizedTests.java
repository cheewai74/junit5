...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // @MethodSource
public class ParameterizedTests {
  ...
  //  @EmptySource
    ...
    @ParameterizedTest
    @CsvSource(value={"steve,32,true","captain,31,false","bucky,5,true"})
    ...
    @ParameterizedTest
    @CsvFileSource(files={"src\\test\\resources\\params\\shoppinglist.csv",
                         "src\\test\\resources\\params\\shoppinglist2.csv"},
            numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(files="src\\test\\resources\\params\\shoppinglist3.csv",
